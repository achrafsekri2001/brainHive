...
import static edu.esprit.entities.Utilisateur.setCurrent_User;
...
public class AjouterReclamationController  implements Initializable {
    ...
    Utilisateur user= new Utilisateur(5,"feriel","@../java/edu/esprit/assets/417957442_1478499912738648_2882908279475441643_n.jpg");
    ...
    private boolean isValidInput() {
        return TF.getText() != null && !TF.getText().isEmpty() &&
                TFp.getText() != null && !TFp.getText().isEmpty();
